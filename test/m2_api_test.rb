...
class M2ApiTest < Test::Unit::TestCase
  ...
  def test_image_list
    ...
    stub_request(:post, 'http://localhost/list_images/')
      .with(
        body: { 'project' => 'bmi_infra' },
        headers: { 'Accept' => '*/*',
                   'Accept-Encoding' => 'gzip;q=1.0,deflate;q=0.6,identity;q=0.3',
                   'Authorization' => 'Basic dXNlcjpwYXNz',
                   'Content-Type' => 'application/x-www-form-urlencoded',
                   'Host' => 'localhost', 'User-Agent' => 'Ruby' }
      )
  ...
  def test_get_target
    ...
    stub_request(:put, 'http://localhost/create_disk')
      .with(
        body: { 'disk_name' => 'test_disk', 'img' => 'test_image',
                'project' => 'bmi_infra' },
        headers: { 'Accept' => '*/*',
                   'Accept-Encoding' =>
                             'gzip;q=1.0,deflate;q=0.6,identity;q=0.3',
      ...
      .to_return(status: 200, body: 'test_target', headers: {})
  ...
  def test_delete_target
    ...
    stub_request(:delete, 'http://localhost/delete_disk')
      .with(
        body: { 'disk_name' => 'test_disk', 'project' => 'bmi_infra' },
        headers: { 'Accept' => '*/*',
                   'Accept-Encoding' =>
                     'gzip;q=1.0,deflate;q=0.6,identity;q=0.3',
                   'Authorization' => 'Basic dXNlcjpwYXNz',
  ...
  def test_get_snapshots
    ...
    stub_request(:post, 'http://localhost/list_snapshots/')
      .with(
        body: { 'project' => 'bmi_infra' },
        headers: { 'Accept' => '*/*',
                   'Accept-Encoding' =>
      ...
      .to_return(status: 200, body: 'test_snapshot', headers: {})
